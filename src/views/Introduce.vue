      ...
      <div class="ladi-container">
          ...
          <div class="ladi-group">
            <div id="IMAGE581" class="ladi-element ladi-animation">
              <div class="ladi-image ladi-transition">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/HtpiAUBWS0w?autoplay=1"
        ...
        <div id="PARAGRAPH189" class="ladi-element">
          <p class="ladi-paragraph">
            <span style="font-weight: bold; color: rgb(255, 237, 0)">"PBL5 2022"</span>
            ...
            <br />
            <br /><span style="font-weight: bold; color: rgb(255, 237, 0)">"PBL5 2022"</span>
            ...
            <span style="color: rgb(255, 237, 0)">
              <span style="font-weight: bold">Chúng em mong muốn phát triển dự án</span></span>
        ...
        <div id="SHAPE193" class="ladi-element">
          <div class="ladi-shape">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" preserveAspectRatio="none"
              viewBox="0 0 233.42 113.44" class="" fill="rgba(151, 1, 20, 1.0)">
    ...
    <div id="SECTION205" class="ladi-section">
      ...
      <div class="ladi-container">
        ...
        <div id="HEADLINE224" class="ladi-element">
          <h3 class="ladi-headline">
            <span style="font-weight: 700">
              <router-link class="link" :to="{ name: 'home' }" style="text-decoration: none; color: inherit; ">Theo dõi
                camera</router-link>
            </span>
          </h3>
        </div>
        <div id="SHAPE223" class="ladi-element">
          <div class="ladi-shape">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" preserveAspectRatio="none"
              viewBox="0 0 134.5 134.5" class="" fill='url("#SHAPE223_desktop_gradient")'>
              <defs id="SHAPE223_defs">
                <linearGradient id="SHAPE223_desktop_gradient" gradientTransform="rotate(0)">
        ...
        <div id="HEADLINE228" class="ladi-element">
          <h3 class="ladi-headline">
            <span style="font-weight: 700">
              <router-link class="link" style="color: inherit; text-decoration: none" :to="{ name: 'classification' }">
                Thống kê chi tiết</router-link>
            </span>
          </h3>
        </div>
        <div id="SHAPE227" class="ladi-element">
          <div class="ladi-shape">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" preserveAspectRatio="none"
              viewBox="0 0 134.5 134.5" class="" fill='url("#SHAPE227_desktop_gradient")'>
              <defs id="SHAPE227_defs">
                <linearGradient id="SHAPE227_desktop_gradient" gradientTransform="rotate(0)">
                  <stop offset="0%" stop-color="#FBD72B"></stop>
                  <stop offset="100%" stop-color="#F9484A"></stop>
                </linearGradient>
              </defs>
        ...
        <!-- test -->
        <div class="img_function" style="top: 275px; right: -100px; position: absolute">
          <a href="/classification" >
             <img src="../assets/chart_introduce.png" alt="" style="width: 450px; object-fit: contain;">
          </a>
        </div>
        <div class="img_function" style="top: 450px; left:-100px; position: absolute">
          <a href="/home">
            <img src="../assets/traffic.jpg" alt="" style="width: 450px; object-fit: contain;">
          </a>
        </div>
        <!-- endtest -->
        ...
        <div id="GROUP855" class="ladi-element">
          <div class="ladi-group">
            <div id="SHAPE517" class="ladi-element">
              <div class="ladi-shape">
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" preserveAspectRatio="none"
                  viewBox="0 0 134.5 134.5" class="" fill="rgba(232, 183, 49, 0.1)">
                  <defs id="SHAPE515_defs">
                    <linearGradient id="SHAPE515_mobile_gradient" gradientTransform="rotate(0)">
                      <stop offset="0%" stop-color="#FBD72B"></stop>
                      <stop offset="100%" stop-color="#F9484A"></stop>
                    </linearGradient>
                  </defs>
